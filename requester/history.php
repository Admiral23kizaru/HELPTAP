...
$query = "SELECT r.*, h.name as helper_name 
          FROM requests r 
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 p-4">
                ...
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i>You haven't made any requests yet.
                </div>
                <?php else: ?>
                <div class="row g-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <span class="text-muted">
                                        <i class="fas fa-user me-1"></i>Helper: <?php echo htmlspecialchars($request['helper_name']); ?>
                                    </span>
                                    <?php endif; ?>
                                </div>
                            </div>

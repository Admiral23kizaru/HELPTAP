...
// Get helper's request history
$query = "SELECT r.*, u.name as requester_name, u.email as requester_email 
          FROM requests r 
          JOIN users u ON r.user_id = u.id 
          WHERE r.helper_id = " . (int)$_SESSION['user_id'] . " 
...
<head>
    ...
    <title>Request History - HelpTap</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 p-4">
                ...
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i>You haven't helped with any requests yet.
                </div>
                <?php else: ?>
                <div class="row g-4">
